...
public class PaymentIntegrationReaderStepListenerTest extends BaseTest {
    ...
    public void afterStepWithSkips() {
        ...
        paymentIntegrationReaderStepListener.setErrorPath("classpath:/test-encrypt/**/error");
        paymentIntegrationReaderStepListener.setSuccessPath("classpath:/test-encrypt/**/success");
        paymentIntegrationReaderStepListener.setWriterTrackerService(writerTrackerService);
        paymentIntegrationReaderStepListener.setApplyEncrypt(false);
        ExitStatus status = paymentIntegrationReaderStepListener.afterStep(stepExecution);
