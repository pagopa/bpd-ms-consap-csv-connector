...
public class PaymentIntegrationItemReaderListenerTest {
    ...
    public void beforeStep_OK() {
        ...
        paymentIntegrationItemReaderListener.setEnableOnErrorLogging(true);
        paymentIntegrationItemReaderListener.setEnableOnErrorFileLogging(true);
        paymentIntegrationItemReaderListener.setResolver(new PathMatchingResourcePatternResolver());
        paymentIntegrationItemReaderListener.setErrorPaymentIntegrationLogsPath("file:/"+folder.getAbsolutePath());
        paymentIntegrationItemReaderListener.afterRead(InboundPaymentIntegration
