...
import it.gov.pagopa.bpd.consap_csv_connector.batch.PaymentInstrumentRemovalBatch;
import it.gov.pagopa.bpd.consap_csv_connector.batch.step.PaymentInstrumentWriter;
import it.gov.pagopa.bpd.consap_csv_connector.connector.config.CsvConnectorBatchJpaConfig;
import it.gov.pagopa.bpd.consap_csv_connector.connector.payment_instrument.PaymentInstrumentConnector;
import it.gov.pagopa.bpd.consap_csv_connector.connector.payment_instrument.PaymentInstrumentRestClient;
import it.gov.pagopa.bpd.consap_csv_connector.service.PaymentInstrumentConnectorService;
