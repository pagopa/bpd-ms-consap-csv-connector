...
public class IntegratedPaymentsReaderStepListenerTest extends BaseTest {
    ...
    public void afterStepWithSkips() {
        ...
        Assert.assertEquals(0,
                FileUtils.listFiles(
                        resolver.getResources("classpath:/test-encrypt-intPayments/**/success")[0].getFile(),
                        new String[]{"pgp"},false).size());

        PaymentInfoReaderStepListener paymentInfoReaderStepListener = new PaymentInfoReaderStepListener();
        paymentInfoReaderStepListener.setErrorPath("classpath:/test-encrypt-intPayments/**/error");
        paymentInfoReaderStepListener.setSuccessPath("classpath:/test-encrypt-intPayments/**/success");
