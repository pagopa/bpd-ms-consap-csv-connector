...
public class IntegratedPaymentsItemReaderListenerTest {
    ...
    public void beforeStep_OK() {
        ...
        Assert.assertEquals(0,
                FileUtils.listFiles(
                        resolver.getResources("classpath:/test-encrypt-intPayments/**/testListener")[0].getFile(),
                        new String[]{"xls"},false).size());
