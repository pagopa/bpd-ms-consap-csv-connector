...
import it.gov.pagopa.bpd.consap_csv_connector.batch.listener.PaymentInstrumentProcessListener;
import it.gov.pagopa.bpd.consap_csv_connector.batch.listener.PaymentInstrumentReadListener;
import it.gov.pagopa.bpd.consap_csv_connector.batch.listener.PaymentInstrumentWriterListener;
import it.gov.pagopa.bpd.consap_csv_connector.batch.listener.TransactionReaderStepListener;
import it.gov.pagopa.bpd.consap_csv_connector.batch.mapper.InboundPaymentInstrumentFieldSetMapper;
import it.gov.pagopa.bpd.consap_csv_connector.batch.mapper.InboundPaymentInstrumentLineMapper;
...
import it.gov.pagopa.bpd.consap_csv_connector.batch.step.InboundPaymentInstrumentItemProcessor;
import it.gov.pagopa.bpd.consap_csv_connector.batch.step.PGPFlatFileItemReader;
import it.gov.pagopa.bpd.consap_csv_connector.batch.step.PaymentInstrumentWriter;
import lombok.Data;
